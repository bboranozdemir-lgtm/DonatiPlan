...
3. Proje oluşturun veya mevcut projeyi seçin.
4. BBS/donatı listesini CSV ya da XLSX olarak yükleyin.
5. Minimum kullanılabilir artık, standart çubuk boyu ve kesim kaybı ayarlarını kontrol edin.
6. Planı optimize edin.
7. Toplam artık, gerçek hurda ve kullanılabilir artık listesini kontrol edin.
8. Excel/PDF raporlarını indirin.
...
Temiz pakette kaynak kod, `scripts`, `README.md`, `KULLANIM.md` ve örnek dosyalar yeterlidir. Böylece hem paket küçülür hem de gerçek saha verisi veya yerel veritabanı yanlışlıkla paylaşılmaz.
